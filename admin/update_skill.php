...
<head>
		...
		<title>Admin - Update Skill</title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-md-15">
						<?php
							$res = mysql_query("select * from tbl_skill where skill_id = '".$_REQUEST['update']."'");
							...
							<form id="form1"  class="form-horizontal" method="post">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Add Skill</h2>
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select id="company" class="form-control" required name="category">													
													<?php
														$result = mysql_query("select * from tbl_category");
														while($row = mysql_fetch_array($result))
														{												
													?>
													<option value = "<?php echo $row["cat_id"]; ?>"<?php if($r['cat_id']==$row['cat_id']) {?> selected="selected" <?php } ?> ><?php echo $row["cat_name"]; ?></option>
													<?php
														}
													?>
												</select>
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Update Skill<span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="updateskill" class="form-control" placeholder="eg.: HTML" data-bvalidator="required" value="<?php echo $r["skill_name"]; ?>"/>
											</div>
										</div>								
									</div>
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<button class="mb-xs mt-xs mr-xs btn btn-warning" name="btnupdate" type="submit">Update Skill</button>
											</div>
										</div>
									</footer>
								</section>
						...
						{
						 mysql_query("update tbl_skill set skill_name='".$_REQUEST['updateskill']."',cat_id ='".$_REQUEST['category']."' where skill_id='".$_REQUEST['update']."'");
						 echo "<script>window.location='view_skill.php';</script>";
						}
						?>
