			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-md-15">
						<?php
							$result = mysql_query("select * from tbl_state where state_id='".$_REQUEST['update']."'");
								...
								<section class="panel">
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Update State<span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="addstate" class="form-control" placeholder="eg.: Gujarat" data-bvalidator="alpha,required" value="<?php echo $row["state_name"]; ?>"/>
											</div>
										</div>								
									</div>
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<button class="mb-xs mt-xs mr-xs btn btn-warning" name="btnstate" type="submit">Update State</button>
											</div>
										</div>
									</footer>
								</section>
						...
						{
						 mysql_query("update tbl_state set state_name='".$_REQUEST['addstate']."' where state_id='".$_REQUEST['update']."'");
