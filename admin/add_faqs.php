				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-md-15">
							<form id="form1" class="form-horizontal" method="post">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Add FAQ</h2>
										
									</header>
									
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">FAQ for<span class="required">*</span></label>
											<div class="col-sm-9">
												<select id="faqs" class="form-control" data-bvalidator="required" name="faqs">
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="quention" class="form-control" placeholder="Enter Question" data-bvalidator="required"/>
											</div>
										</div>								
									</div>
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-md-9">
													<textarea class="form-control" name="answer" rows="3" id="textareaDefault" placeholder="Enter Answer" data-bvalidator="required"></textarea>
												</div>
										</div>								
									</div>
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<button class="mb-xs mt-xs mr-xs btn btn-warning" name="btnaddfaq">Add FAQ</button>											
											</div>
										</div>
									</footer>
								</section>
							...
							<?php
								if(isset($_REQUEST['btnaddfaq']))
								
								{
									$result = mysql_query ("insert into tbl_faq values (NULL,'".$_REQUEST["faqs"]."','".$_REQUEST["quention"]."','".$_REQUEST["answer"]."');");
							?>
