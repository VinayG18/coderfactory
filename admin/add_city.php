					...
					<div class="row">
						<div class="col-md-15">
							<form id="form1" class="form-horizontal" method="post">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Add City</h2>
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select id="state" class="form-control" data-bvalidator="required" name="state">
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Add City<span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="addcity" class="form-control" placeholder="eg.: Surat" data-bvalidator="alpha,required"/>
											</div>
										</div>								
									</div>
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<button class="mb-xs mt-xs mr-xs btn btn-warning" name="btnaddcity">Add City</button>											
											</div>
										</div>
									</footer>
								</section>
							...
							<?php
								...
								{
									$res = mysql_query("select * from tbl_city where city_name = '".$_REQUEST['addcity']."'");
									if(mysql_num_rows($res)>0)
									{
							?>
										<div class="alert alert-warning">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
											<strong>City Name is Already Exists.</strong>
										</div>
							<?php
									...
									{
										$result = mysql_query ("insert into tbl_city values (NULL,'".$_REQUEST["addcity"]."','".$_REQUEST["state"]."');");
							?>
