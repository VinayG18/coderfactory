			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Manage FAQs</span></li>
								<li><span>Update FAQ</span></li>
							</ol>
					...
					<div class="row">
						<div class="col-md-15">
						<?php
							$res = mysql_query("select * from tbl_faq where faq_id='".$_REQUEST['update']."'");
							...
							<form id="form1" class="form-horizontal" method="post">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Update FAQ</h2>
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Update Question<span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="quention" class="form-control" placeholder="Enter Question" data-bvalidator="required" value="<?php echo $r["question"]; ?>"/>
											</div>
										</div>								
									</div>
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Update Answer<span class="required">*</span></label>
											<div class="col-md-9">
													<textarea class="form-control" name="answer" rows="3" id="textareaDefault" placeholder="Enter Answer" data-bvalidator="required"><?php echo $r["answer"]; ?></textarea>
												</div>
										</div>								
									</div>
									...
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<button class="mb-xs mt-xs mr-xs btn btn-warning" name="btnaddcity" type="submit">Update FAQ</button>											
											</div>
										</div>
									</footer>
								</section>
						...
						{
						 mysql_query("update tbl_faq set question='".$_REQUEST['quention']."',answer ='".$_REQUEST['answer']."' where faq_id='".$_REQUEST['update']."'");
						 echo "<script>window.location='view_faqs.php';</script>";
						}
						?>
						<!-- col-md-6 -->
