			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-md-15">
						<?php
							$result = mysql_query("select * from tbl_category where cat_id='".$_REQUEST['update']."'");
								...
								<section class="panel">
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Update Category<span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="addcategory" class="form-control" placeholder="eg.: IT & Programming" data-bvalidator="required" value="<?php echo $row["cat_name"]; ?>"/>
											</div>
										</div>								
									</div>
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<button class="mb-xs mt-xs mr-xs btn btn-warning" name="submit" type="submit">Update Category</button>												
											</div>
										</div>
									</footer>
								</section>
						...
						{
						 mysql_query("update tbl_category set cat_name='".$_REQUEST['addcategory']."' where cat_id='".$_REQUEST['update']."'");
