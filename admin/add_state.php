					...
					<div class="row">
						<div class="col-md-15">
								...
								<section class="panel">
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Add State<span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="addstate" class="form-control" placeholder="eg.: Gujarat" data-bvalidator="alpha,required"/>
											</div>
										</div>								
									</div>
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<button class="mb-xs mt-xs mr-xs btn btn-warning" name="btnstate">Add State</button>
											</div>
										</div>
									</footer>
								</section>
							...
							<?php
								...
								{ 
									$res = mysql_query("select * from tbl_state where state_name = '".$_REQUEST['addstate']."'");
							...
							?>
										...
										<div class="alert alert-warning">
											...
											<strong>State Name is Already Exists.</strong>
										</div>
							<?php
									}
									else
									{
										...
										mysql_query("insert into tbl_state values(NULL,'".$_REQUEST['addstate']."')");
							?>	
