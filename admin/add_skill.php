					...
					<div class="row">
								...
								<section class="panel">
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select id="company" class="form-control"  name="category" data-bvalidator="required">
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Add Skill<span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="txtaddskill" class="form-control" placeholder="eg.: HTML" data-bvalidator="required"/>
											</div>
										</div>								
									</div>
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<button class="mb-xs mt-xs mr-xs btn btn-warning" type="submit" name="addskill">Add Skill</button>
											</div>
										</div>
									</footer>
								</section>
						...
						<?php
							if(isset($_REQUEST['addskill']))
							{
								...
								$res=mysql_query("select * from tbl_skill where skill_name='".$_REQUEST["txtaddskill"]."'");
								if(mysql_num_rows($res)>0)
								{
						?>
									<div class="alert alert-warning">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
											<strong>Skill Name is Already Exists.</strong>
									</div>
						<?php
								}
								else
								{								
								$result = mysql_query("insert into tbl_skill values (NULL,'".$_REQUEST["txtaddskill"]."','".$_REQUEST["category"]."');");
						?>
