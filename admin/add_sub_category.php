				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-md-15">
							<form id="form1"  class="form-horizontal" method="post">
								<section class="panel">
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Add Sub Category<span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="txtsubcat" class="form-control" placeholder="eg.: Website" data-bvalidator="required"/>
											</div>
										</div>								
									</div>
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<button class="mb-xs mt-xs mr-xs btn btn-warning" name="btnsubcat">Add Sub Category</button>
											</div>
										</div>
									</footer>
								</section>
						...
						<?php
							...
							{
								$res = mysql_query("select * from tbl_sub_category where sub_cat_name = '".$_REQUEST['txtsubcat']."'");
								if(mysql_num_rows($res)>0)
								{
						?>
									<div class="alert alert-warning">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
											<strong>Sub Category Name is Already Exists.</strong>
									</div>
						<?php
								}
								else
								{
									$result = mysql_query("insert into tbl_sub_category values (NULL,'".$_REQUEST["txtsubcat"]."','".$_REQUEST["category"]."');");
						?>
