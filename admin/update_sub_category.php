			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Update Sub Category</span></li>
							</ol>
					...
					<div class="row">
						<div class="col-md-15">
						<?php
							$res = mysql_query("select * from tbl_sub_category where sub_cat_id='".$_REQUEST['update']."'");
							...
							<form id="form1"  class="form-horizontal" method="post">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Update Sub Category</h2>
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Update Sub Category<span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="txtsubcat" class="form-control" placeholder="eg.: Website" data-bvalidator="required" value="<?php echo $r["sub_cat_name"]; ?>"/>
											</div>
										</div>								
									</div>
									<footer class="panel-footer">
										<div class="row">
											<div class="col-sm-9 col-sm-offset-3">
												<button class="mb-xs mt-xs mr-xs btn btn-warning" name="btnsubcat" type="submit">Update Sub Category</button>
											</div>
										</div>
									</footer>
								</section>
						...
						{
						 mysql_query("update tbl_sub_category set 	sub_cat_name='".$_REQUEST['txtsubcat']."',cat_id='".$_REQUEST['category']."' where sub_cat_id='".$_REQUEST['update']."'");
						 echo "<script>window.location='view_sub_category.php';</script>";
						}
						?>
						<!-- col-md-6 -->
